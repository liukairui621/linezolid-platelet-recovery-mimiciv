...
para(d,'The selected MIMIC-IV cohort included 65 linezolid and 2492 vancomycin initiations. Fourteen and 1019 admissions met the primary recovery definition. Overlap-weighted probabilities were 21.22% and 32.13% (difference, −10.92 percentage points; 95% CI, −20.12 to −3.19). We explicitly report the small exposed event count, residual indication confounding, documentation limitations, and the difference between observed recovery and a biological drug effect. Reviewer-requested parenteral-route and multiple-imputation sensitivities are identified as post-result exploratory analyses and do not change the causal interpretation boundary.')
